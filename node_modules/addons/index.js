var BASE_CONFIG_URL = "https://launchpack.io/api/v1/apps/config";

var ADDONS_JSON_PATH = "addons.json";
var GIT_IGNORE_FILE_PATH = '.gitignore';
var GIT_IGNORE_TEXT = "# Launchpack.io\r\n" + ADDONS_JSON_PATH + "\r\n";
...
fetchAndSetEnvVars = function() {
  ...
  var configUrl = BASE_CONFIG_URL + "?app_id=" + process.env.ADDONS_APP_ID + "&app_token=" + process.env.ADDONS_APP_TOKEN + "&source=npm";
  ...
  request(configUrl, function (error, response, body) {
    if (!error && response.statusCode == 200) {
      ...
      console.error("Error: Unauthorized. ADDONS_APP_ID or ADDONS_APP_TOKEN is invalid.");
...
module.exports = function() {
  ...
  if (process.env.ADDONS_APP_ID == undefined) {
    console.error("Error: process.env.ADDONS_APP_ID must be defined");
  } else if (process.env.ADDONS_APP_TOKEN == undefined) {
    console.error("Error: process.env.ADDONS_APP_TOKEN must be defined");
